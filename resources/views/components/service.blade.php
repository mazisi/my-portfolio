                        ...
                        <div class="row g-4">
                            <div class="col-lg-4 col-md-6">
                                <div class="card-servies-2 rounded-2 h-100 hover-up">
                                    ...
                                    <p class="fs-7 text-300 fw-regular">Crafting visually appealing and user-friendly interfaces using <span class="text-secondary-2">Laravel</span>, <span class="text-secondary-2">backend</span>, <span class="text-secondary-2">JavaScript</span>, and modern frameworks like React, Vue and Angular.</p>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6">
                                <div class="card-servies-2 rounded-2 h-100 hover-up">
                                    ...
                                    <p class="fs-7 text-300 fw-regular">Designing and managing databases with SQL and NoSQL technologies such as <span class="text-secondary-2">MySQL</span>, 
                                    <span class="text-secondary-2">PostgreSQL</span>, and <span class="text-secondary-2">Firebase</span>.</p>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6">
                                <div class="card-servies-2 rounded-2 h-100 hover-up">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="card-servies-2 rounded-2 h-100 hover-up">
                                    ...
                                    <h6 class="my-3 fw-medium">Search Engine Optimization</h6>
                                    <p class="fs-7 text-300 fw-regular">Optimizing your website for <span class="text-secondary-2">search engines</span> to increase visibility and drive traffic to your website.</p>
                                </div>
                            </div>
                        </div>
