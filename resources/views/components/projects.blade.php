    ...
    <div class="container">
        <div class="rounded-3 border border-1 position-relative overflow-hidden">
            <div class="box-linear-animation position-relative z-1">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="p-lg-5 p-md-4 p-3 border border-1 mt-5 bg-3">
                                        <div class="row">
                                            <div class="col-lg-5">
                                                <img class="w-100" src="{{ asset('imgs/ttg.png') }}" alt="Tone Tracker" />
                                            </div>
                                            <div class="col-lg-7 ps-lg-5 mt-5 mt-lg-0">
                                                <h4 class="text-linear-4">
                                                    Build frontend for <br />
                                                    ToneTracker system
                                                </h4>
                                                <p>Developed tonetracker system using Vue 3 and Vite.</p>
                                                <ul class="mt-4 list-unstyled">
                                                    ...
                                                    <li class="text-dark mb-3 border-bottom pb-3">
                                                        <div class="d-flex justify-content-between">
                                                            ...
                                                            <p class="text-300 mb-0 text-end">4th Motion</p>
                                                        </div>
                                                    </li>
                                                    <li class="text-dark mb-3 border-bottom pb-3">
                                                        <div class="d-flex justify-content-between">
                                                            <p class="text-dark mb-0 text-end">Completion Time</p>
                                                            <p class="text-300 mb-0 text-end">4 months</p>
                                                        </div>
                                                    </li>
                                                    <li class="text-dark mb-3 border-bottom pb-3">
                                                        <div class="d-flex justify-content-between">
                                                            <p class="text-dark mb-0 text-end">Technologies</p>
                                                            <p class="text-300 mb-0 text-end">VueJs, Springboot & MySQL</p>
                                                        </div>
                                                    </li>
                                                </ul>
                                ...
                                <div class="swiper-slide">
                                    <div class="p-lg-5 p-md-4 p-3 border border-1 mt-5 bg-3">
                                        <div class="row">
                                            <div class="col-lg-5">
                                                <img class="w-100" src="{{ asset('imgs/heromed.PNG') }}" alt="Mazisi" />
                                            </div>
                                            <div class="col-lg-7 ps-lg-5 mt-5 mt-lg-0">
                                                <h4 class="text-linear-4">
                                                    Build frontend for Heromed  <br />
                                                    Internal Portal
                                                </h4>
                                                <p>Developed heromed system using React.</p>
                                                <ul class="mt-4 list-unstyled">
                                                    <li class="text-secondary-2 mb-3 border-bottom pb-3">Project Info</li>
                                                    <li class="text-dark mb-3 border-bottom pb-3">
                                                        <div class="d-flex justify-content-between">
                                                            <p class="text-dark mb-0 text-end">Client</p>
                                                            <p class="text-300 mb-0 text-end">Heromed</p>
                                                        </div>
                                                    </li>
                                                    <li class="text-dark mb-3 border-bottom pb-3">
                                                        <div class="d-flex justify-content-between">
                                                            <p class="text-dark mb-0 text-end">Completion Time</p>
                                                            <p class="text-300 mb-0 text-end">3 months</p>
                                                        </div>
                                                    </li>
                                                    <li class="text-dark mb-3 border-bottom pb-3">
                                                        <div class="d-flex justify-content-between">
                                                            <p class="text-dark mb-0 text-end">Technologies</p>
                                                            <p class="text-300 mb-0 text-end">React, Springboot, MySQL</p>
                                                        </div>
                                                    </li>
                                                </ul>
                                                <div class="d-flex flex-wrap align-items-center gap-3 mt-7">
                ...
                <img class="position-absolute top-0 start-0 z-0" src="{{ asset('imgs/home/projects/bg.png') }}" alt="Msebele" />
            </div>
        </div>
    </div>
</section>